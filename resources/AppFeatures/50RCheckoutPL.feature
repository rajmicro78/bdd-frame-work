Feature: Registered user checkout with paylater card
@Run

 Scenario Outline: Registered user randomly select a product and do the checkout with pay later payment
