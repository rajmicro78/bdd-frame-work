Feature: Registered user buy Gift Certificate

  @Run
  Scenario Outline: Registered user buy Gift Certificate
    ...
    And You are on the Homepage
    And Search for "Gift Certificate"
